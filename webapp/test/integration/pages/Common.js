sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("contactsapp/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("contactsapp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["contactsapp/localService/mockserver"], function (mockserver) {
