sap.ui.define([
		...
		return BaseObject.extend("contactsapp.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias contactsapp.model.ListSelector
			 */
			 ...
			 * @return {contactsapp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
